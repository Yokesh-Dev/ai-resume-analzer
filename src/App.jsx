...
pdfjsLib.GlobalWorkerOptions.worderSrc = pdfjsworker;
...
function App() {
  ...
  const extractPDFText = async (file) => {
    ...
    const pdf = await pdfjsLib.geDocument({ data: arrayBuffer }).promise;
    const texts = await Promise.all(
      Array.from({ length: pdf.numPages },
        (_i) => pdf.getPage(i + 1)
          .then((page) => page.getTextContent().then((tc) => tc.items.map((i) => i.str).join(""))))
    )
    return texts.join("\n").trim();
  };
  ...
  const parseJSONResponse = (reply) => {
    try {
      ...
      throw Error(`Failed to parse AI response: ${err.message}`)
    }
  };

  //Function analyse Resume
  const analyzeResume = async (text) => {
    const propmt = constants.ANALYZE_RESUME_PROMPT.replace(
      "{{DOCUMENT_TEXT}}",
      text
    );
    ...
    <div className="min-h-screen bg-main-gradient p-4 sm:p-6 lg:p-8 flex items-center justify-center">
      ...
      <div className="max-w-5xl mx-auto w-full">
        <div className="text-center mb-6">
          <h1 className="text-5xl sm:text-6xl lg:text-7xl font-light bg-gradient-to-r from-cyan-300 via-teal-200 to-sky-300 
        ...
        {!uploadedFile && (
          <div className="upload-area">
            <div className="upload-zone">
              ...
              <p className="text-slate-400 mb-4 sm:mb-6 text-sm sm:text-base">PDF files only . Get instant anlysis</p>
              <input type="file"
                accept=".pdf"
        ...
        {isLoading && (<div className="p-6 sm:p-8 max-w-md mx-auto">
          ...
          <div className="space-y-6 p-4 sm:px-8 lg:px-16">
            <div className="file-info-card">
              <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
                ...
                <div className="flex items-center gap-4">
                  <div className="icon-container-xl bg-gradient-to-br from-blue-500/20 to-cyan-500/30 border-blue-500/30">
                    <span className="text-3xl">📄</span>
                  </div>
                </div>
                <h3 className="text-xl font-bold text-green-500 mb-1">Anlalysis Complete</h3>
            ...
            <div className="score-card">
              <div className="text-center mb-6">
                ...
                <div className={`inline-flex items-center gap-2 mt-3 px-4 py-2 rounded-full ${parseInt(analysis.overallScore) >= 8 ? "Score status Excellent "
                  : parseInt(analysis.overallScore) >= 6 ? "Score-status-good"
              ...
              <div className="progress-bar">
                <div className={`h-full rounded-full transition-all duration-1000 ease-out shadow-sm ${parseInt(analysis.overallScore) >= 8 ? "progress-excellent" : parseInt(analysis.overallScore) >= 6 ? "progress-good" : "progress-imporovement"
                  }`}
                  style={{
            ...
            <div className="grid sm:grid-cols-2 gap-4">
              <div className="feature-card-green group">
                ...
                <div className="space-y-2 text-left">
                  {analysis.strengths.slice(0, 3).map
                    ((strength, index) => (
                      <div key={index} className="list-item-green"> <span className="text-green-400 text-sm mt-0.5"> .</span>
                        <span className="text-slate-200 text-sm font-medium text-sm leading-relaxed ">{strength}</span>
                      </div>
                    ))
                  }
                </div>
              ...
              <div className="feature-card-orange group">
                ...
                <div className="space-y-2 text-left">
                  {improvements.strengths.slice(0, 3).map
                    ((improvement, index) => (
                      <div key={index} className="list-item-orange"> <span className="text-orange-400 text-sm mt-0.5"> .</span>
                        <span className="text-slate-200 text-sm font-medium text-sm leading-relaxed ">{improvement}</span>
                      </div>
                    ))}
                </div>
              </div>
            ...
            <div className="section-card group">
              ...
              <div className="summary-box">
                ...
                sm:text-base leading-relaxed">{analysis.
                    summary}</p>
              </div>
            </div>
            ...
            <div className="section-card group">
              ...
              <div className="space-y-4 ">
                {METRIC_CONFIG.map((cfg, i) => {
                  ...
                  return (
                    <div key={i} className="group/item"> <div className="flex items-center justify-between mb-2">
                      <div className="flex items-center gap-2 ">
                        <span className="text-lg">{cfg.icon} </span>
                        <p className="text-slate-200 font-medium">{cfg.label}
                        </p>
                      </div>
                      <span className="text-slate-300 font-bold"> {value}/10</span>
                    </div>
                      <div className="progress-bar-small">
                        <div className={`h-full bg-gradient-to-r ${cfg.colors} rounded-full transition-all duration-1000 ease-out group-hover/item:shadow-lg  ${cfg.shadowClass}`}
                ...
                <div className="info-box-emerald group/item">
                  ...
                  <div className="space-y-2">
                    {(analysis.proTips || [
                      ...
                      "Keep descriptions concise and impactul",
            ...
            <div className="section-card-group">
                ...
                <div className="flex items-start-gap-3 mb-3">
                  <div>
                    ...
                    <p className="text-slate-200 text-sm leading-relaxed ">
                      <strong className="text-violet-300">Applicant Tracking Systems (ATS)</strong> {" "}
                      are software tools used by 75%+ of  employers to
                      automatically screen resumes before human review. These systems scan for keywords, proper
                      formatting, and relevant
                      qualifications to rank candidates.
                      If your resume isn't
                      ATS-friendly, it may never reach a
                      human recruiter.
                    </p>
                  </div>
                </div>
              ...
              <div className="info-box-violet">
                <div className="flex items-center gap-3 mb-3">
                  <span className="text-lg">🤖</span>
                  <h3 className="text-violet-300 font-semibold text-lg ">ATS  Compitablity Checklist</h3>
                </div>
                <div className="space-y-2">
            ...
            <div className="section-card group">
              <div className="flex items-center gap-3 mb-6">
                ...
                <h2 className="text-blue-400 font-bold text-xl ">Recomended Keywords</h2>
              </div>
              <div className="flex flex-wrapgap-3 mb-4 ">
